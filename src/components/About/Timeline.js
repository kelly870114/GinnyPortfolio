    ...
    return (
        <VerticalTimeline lineColor='#F5B42B'>
            <VerticalTimelineElement
                ...
                // 字顏色
                contentStyle={{ color: '#333333' ,background:'#ffffff'}}
            ...
            >
                ...
                <p>
                    <ul style={{textAlign: 'left'}}>
                        <li>Participated in three banking projects in agile environment to deliver high-quality software.</li>
                        <li>Responsible for 40+ requirements and all of them successfully go-live on time.</li>
                        <li>Attended 5+ requirement meetings with clients to clarify their requirements and implemented
design thinking to solve their problems.</li>
            ...
            <VerticalTimelineElement
                ...
                <p>
                <ul style={{textAlign: 'left'}}>
                        <li>Participated in Shin Kong Hospital – HIS & NIS Migration project (Microsoft’s largest project
in Asia Pacific Region in 2017) in an agile environment and collaborated with 100+ team members.</li>
                        <li>Developed the system with backend .Net using C# and frontend using Typescript, Knockout.js and Vue.js,
Microsoft SQL Server (Relational database) as database.</li>
                        <li>Improved printing quality by using the SSRS and reached the quantity to over 10,000+ sheets per day.</li>
                        <li>Collaborate with programmers and UI/UX team to resolve issues.</li>
                    </ul>
                </p>
            </VerticalTimelineElement>
