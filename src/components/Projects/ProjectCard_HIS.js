...
export default function MediaCard() {
    ...
    return (
        <Card sx={{ maxWidth: 500, boxShadow: 3 }}>
            <CardMedia component="img" height="200" image={HospitalCover} alt="HIS Cover" />
            <CardContent>
                <Typography
                    gutterBottom
                    variant="h5"
                ...
                <Typography variant="body2" style={{ fontSize: '15px', fontFamily: 'Raleway', color: '#333333' }}>
                    ...
                    >
                        ...
                        <Box sx={box_style}>
                            <CCallout color="warning">
                                <small>
                                    This project is Microsoft’s <strong>largest</strong> project in Asia Pacific Region
                                    in 2017
                                </small>
                            </CCallout>
                            ...
                            <Typography variant="subtitle1">
                                <strong>
                                    Mostly responsible for hospital pharmacy system and outpatient system development.{' '}
                                </strong>
                            </Typography>
                            <Typography variant="body1">
                                - Developed the printings sheets and printing functions in the HIS system.
                                <br />- Using SQL Server Reporting Services (SSRS) and get the datasets from MS SQL
                                Server.
                            </Typography>
                            <br />
                            <Typography variant="subtitle1">
                            ...
                            <img
                                src={HospitalEx2}
                                style={{ maxHeight: '600px', maxWidth: '400px', position: 'relative' }}
                            />
                            <br />
                        </Box>
                    </Modal>
